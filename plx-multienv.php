...
if ( !(defined('PLX_MULTIENV_FILES_INSTALLED')) && !(isset($_GET['page'])) && !($_GET['page'] == 'plx-multienv-menu-environments') ) {
...
function plx_multienv_environments_page() {
	...
	?>
			...
			<p>You can edit certain global wordpress settings in the new wp-config.php file but all other files are dynamically generated by the plugin and shouldn't be edited directly.</p>
			<form method="post">
	        ...
	        <tr valign="top">
	        	<th scope="row">Development Hostname</th>
						<td>
