...
$plx_multienv_template_prod = '<?php
/**
...
define(\'DB_NAME\', \'' . $plx_multienv_config_prod_dbname . '\');
define(\'DB_USER\', \'' . $plx_multienv_config_prod_dbuser . '\');
define(\'DB_PASSWORD\', \'' . $plx_multienv_config_prod_dbpass . '\');
define(\'DB_HOST\', \'' . $plx_multienv_config_prod_dbhost . '\');
define(\'WP_DEBUG\', ' . $plx_multienv_config_prod_wpdebug . ');
';